...
public class Terrain implements IConfig, Serializable {
	...
	public enum TypeTerrain {
		...
		HERBE (COULEUR_HERBE, true, null, null),
		ROCHER (COULEUR_ROCHER, false, null, null),
		FORET (COULEUR_FORET, true, Effet.TypeEffet.FORET_DENSE, TypeMoment.TANT_QUE_DESSUS),
		EAU (COULEUR_EAU, false, null, null),
		PONT (COULEUR_PONT, true, null, null),
		FEU (COULEUR_FEU, true, null, null),
		ACIDE (COULEUR_ACIDE, true, Effet.TypeEffet.POISON, TypeMoment.FIN_TOUR),
		VILLAGE (COULEUR_VILLAGE, true, Effet.TypeEffet.SOUTIEN_POPULAIRE, TypeMoment.DEBUT_TOUR),
		SABLE (COULEUR_SABLE, true, Effet.TypeEffet.SABLES_MOUVANTS, TypeMoment.TANT_QUE_DESSUS);
		...
		TypeTerrain(Color couleur, boolean accessible, Effet.TypeEffet effet, TypeMoment moment) { 
