...
public interface IConfig {
	...
	int LARGEUR_PANNEAU_L = 325, HAUTEUR_PANNEAU_L = HAUTEUR_CARTE * NB_PIX_CASE ;
	int LARGEUR_PANNEAU_BAS = LARGEUR_PANNEAU_L * 2 + LARGEUR_CARTE * NB_PIX_CASE;
	int HAUTEUR_PANNEAU_BAS = 100;
	int LARGEUR_FENETRE = LARGEUR_PANNEAU_BAS, HAUTEUR_FENETRE = HAUTEUR_PANNEAU_L + HAUTEUR_PANNEAU_BAS;
