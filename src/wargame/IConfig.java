...
public interface IConfig {
	...
	*/
	...
	int HAUTEUR_PANNEAU_BAS = 100;
	int HAUTEUR_PANNEAU_JMENU = 50;

	// -------- Hauteur totale --------
	int HAUTEUR_FENETRE = HAUTEUR_PANNEAU_JMENU + HAUTEUR_PANNEAU_CARTE + HAUTEUR_PANNEAU_BAS;

	int LARGEUR_PANNEAU_BAS  = LARGEUR_FENETRE;
	int LARGEUR_PANNEAU_JMENU = LARGEUR_FENETRE;
